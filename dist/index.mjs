...
import UnifyEmitter3 from "unify-emitter";
...
var GameObject = class extends UnifyEmitter3 {
  constructor() {
    super(...arguments);
...
import UnifyEmitter4 from "unify-emitter";
var _uniqueName, _health2, _type2, _angle2, _id2, _x3, _y3, _isInitialized3;
var GameAI = class extends UnifyEmitter4 {
  constructor() {
    super();
